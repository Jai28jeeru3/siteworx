...
import WL from "../imge/Wl1.jpg"; // Adjust the path as necessary
import cloudGif from "../imge/cloud-network.gif";
      ...
      <div className="flex flex-row items-center justify-center w-full max-w-5xl mt-8">
        <div className="p-8 w-full max-w-2xl text-center" style={{ background: 'transparent', boxShadow: 'none' }}>
          <h1 className="text-3xl font-bold">
            Shared Hosting <span className="text-red-600">5% OFF</span>
          </h1>
          <p className="mt-4 text-lg text-gray-700">
            We offer the best hosting solutions for your needs, catering to clients from personal to corporate. Our data centers are strategically located worldwide to ensure that your website is always up. Happy hosting!
          </p>
