...
import Img4 from '../imge/images4.jpg';
import Img5 from '../imge/images5.jpg';
...
const SpeedIcon = () => (
  <span style={{ display: 'inline-block', width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', background: '#e2efff' }}>
    <img src={T5669487} alt="Speed" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  </span>
);

const SupportIcon = () => (
 <span style={{ display: 'inline-block', width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', background: '#e2efff' }}>
    <img src={Img1} alt="support" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  </span>
);

const ControlPanelIcon = () => (
  <span style={{ display: 'inline-block', width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', background: '#e2efff' }}>
    <img src={Img2} alt="control panel" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  </span>
);

const SecurityIcon = () => (
  <span style={{ display: 'inline-block', width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', background: '#e2efff' }}>
    <img src={Img3} alt="security" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  </span>
);

const LayersIcon = () => (
  <span style={{ display: 'inline-block', width: 64, height: 64, borderRadius: '50%', overflow: 'hidden', background: '#e2efff' }}>
    <img src={Img4} alt="layers" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
  </span>
);
